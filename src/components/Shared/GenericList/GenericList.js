            ...
            <section className={`generic-table ${this.props.containerClassName || ''}`}>
                {
                    this.props.header !== 'without-header' && 
                        ...
                        {
                            this.props.header && this.props.header !== 'no-header' ? <h1>{this.props.header}</h1> : <h1 aria-labelledby="header" className="empty-header">&nbsp;</h1>
                        }
                        {
                        ...
                        }
                        {
                            ...
                            <div className="search-wrapper">
                                <div className="search-container">
                                    ...
                                    <button aria-label="Reset Search" onClick={() => this.resetSearch()} className="btn-none btn-clear">
                                        <i className={`fas fa-times ${this.state.searchValue.length > 0 ? '' : 'hidden'}`} />
                                    </button>
                                    <button aria-label="Text Search Icon" onClick={() => this.setState({ enableHighlight: !this.state.enableHighlight })} className="btn-none btn-highlight">
